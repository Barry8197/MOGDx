...
#SBATCH --output=/home/%u/slurm_logs/output/slurm-%A_%a.out

# Location for stderr log - see https://slurm.schedmd.com/sbatch.html#lbAH
#SBATCH --error=/home/%u/slurm_logs/error/slurm-%A_%a.out
...
#source /home/s2180082/miniconda3/etc/profile.d/conda.sh
source ~/.bashrc
...
src_path=/home/${USER}/MOGDx/raw

# input data directory path on the scratch disk of the node
dest_path=${SCRATCH_HOME}/MOGDx/raw
...
src_path=${SCRATCH_HOME}/MOGDx/output
dest_path=/home/${USER}/MOGDx/output
rsync --archive --update --compress --progress ${src_path}/ ${dest_path}
