...
def combine_embeddings(reduced_df) :
    '''
    Combines the embeddings per patient in each of the train,test and validation splits.
    Performs median imputation if a patient is missing samples in one modality.
    ''' 
    joined_df = {}
